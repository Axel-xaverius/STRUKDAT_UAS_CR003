...
const string ADMIN_USERNAME = "adminAXEL";
const string ADMIN_PASSWORD = "AXEL123";
        ...
        switch (choice) {
            ...
            case 2:
                if (!isLoggedIn) {
                    ...
                    cout << "Akses anda ditolak. Hanya admin yang dapat menambah produk.\n";
                }
                break;
            case 3:
                if (isLoggedIn) {
                    if (isAdmin) {
                        ...
                        cout << "Akses anda ditolak. Hanya admin yang dapat mengubah produk.\n";
                    }
                } else {
